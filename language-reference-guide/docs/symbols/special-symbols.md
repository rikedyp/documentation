<h1 class="heading"><span class="name">Special Symbols</span></h1>

|---|---|
|**Hash** is a namespace identifier. {: .shaded }||
...
|**Alpha** identifies left arguments of dfns/dops. {: .shaded }||
...
|**Omega** identifies right arguments of dfns/dops. {: .shaded }||
...
|**Del** is used for self-reference in dfns/dops (as well  as for the traditional APL Line Editor). {: .shaded }||
...
|; [Index Separator](../primitive-functions/indexing.md)|; [Localize Name](../../../programming-reference-guide/defined-functions-and-operators/traditional-functions-and-operators/global-local-names)|
|**High Minus** or Overbar is used to indicate that a number is negative. {: .shaded }||
