...
|**Colon** in a tradfn terminates a line label or starts a control word; in a dfn/dop forms a guard or error guard; in array notation joins a name-value pair. {: .shaded }||
