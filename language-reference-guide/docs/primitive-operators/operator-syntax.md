...
![Function composition diagram for atop](../img/atop-composition.png){: style="max-height: 25em"}

## Behind

![Function composition diagram for monadic behind](../img/behind-monadic-composition.png){: style="max-height: 25em"}


![Function composition diagram for dyadic behind](../img/behind-dyadic-composition.png){: style="max-height: 25em"}

## Beside

![Function composition diagram for beside](../img/beside-composition.png){: style="max-height: 25em"}

## Over

![Function composition diagram for over](../img/over-composition.png){: style="max-height: 25em"}
